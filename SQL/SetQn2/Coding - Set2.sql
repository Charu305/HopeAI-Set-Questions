...
-- Question 1: Retrieve all employees whose salary is greater than 60000.

SELECT *
FROM employees
WHERE salary > 60000;

-- Question 2: Calculate the total sales amount for each customer from the sales table.
...
-- Question 4: Find the total sales amount made on 2023-03-17 from the sales table.

SELECT SUM(amount) AS total_sales
FROM sales
WHERE sale_date = '2023-03-17';

-- Question 5: Get the names of customers who have placed an order of more than 600 from the orders table.
